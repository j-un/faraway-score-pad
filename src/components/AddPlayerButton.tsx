...
export const AddPlayerButton = ({ onAddPlayer }: AddPlayerButtonProps) => {
  return (
    <button
      onClick={onAddPlayer}
      className="h-24 rounded-xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center gap-2 text-slate-400 hover:text-orange-500 hover:border-orange-400 hover:bg-orange-50 transition-all group bg-white/50 p-4"
    >
